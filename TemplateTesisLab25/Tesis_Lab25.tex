...
\addbibresource{Bib_Lab25.bib} % The filename of the bibliography
...
\thesistitle{Título de la Tesis} % Your thesis title, print it with \ttitle
\supervisor{Dr. Arturo Bouzas Riaño} % Your supervisor's name, print it with \supname
\examiner{Dr. Revisor} % Your examiner's name, print it with \examname
\degree{Licenciatura en Psicología} % Your degree name, print it with \degreename
\author{Adriana Felisa Chávez De la Peña}% Your name, print it with \authorname
...
\include{Appendices/App_Ejemplo}
